...
#     # budgets
#     #path('budgets/', BudgetCreateView.as_view(), name='budget_create'),
#     path('budgets/<int:pk>/', BudgetEditView.as_view(), name='budget_edit'),
#     path('budgets/list/', BudgetListView.as_view(), name='budget_list'),
...
urlpatterns = [
    path('admin/', admin.site.urls),
    #path('', include('budget.urls')),  # Aqui estamos incluindo as URLs do app budget
